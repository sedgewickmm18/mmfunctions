...
class VerySimpleModel:
    def __init__(self, min, max, standard_cycle):
        self.Min = min
        self.Max = max
        self.Median = standard_cycle
